...
# The modules under test are stowed config, not library code: they ship to
# ~/.config/shared/scripts/ so cycle-audio-output.sh can call a sibling instead
# of reaching into another repo. Import them from where they actually live.
sys.path.insert(0, str(REPO_ROOT / "shared" / ".config" / "shared" / "scripts"))
